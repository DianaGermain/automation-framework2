    ...
    private static WebDriver createDriver()  {
        ...
        switch (getBrowserType()) {
            case "chrome" -> {
                ...
                chromeOptions.setPageLoadStrategy(PageLoadStrategy.NORMAL); //waits for page to load
            ...
            case "firefox" -> {
                ...
                firefoxOptions.setPageLoadStrategy(PageLoadStrategy.NORMAL); //waits for page to load
